...
// const Manglik = require("../models/Manglik"); // MongoDB model
...
//   try {
//     // Dummy Manglik calculation logic
//     const isManglik = Math.random() < 0.5 ? true : false;

//     // Save to DB
//     const calculation = new Manglik({
//       name,
//       dateOfBirth,
//       timeOfBirth,
//       placeOfBirth,
...
//     // Return response
//     res.json({
//       message: "Manglik calculation successful",
//       calculation,
//     });
//   } catch (err) {
